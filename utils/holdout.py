...
from utils.helper import StratifiedKFold
...
class Holdout:
    ...
    def stratified_split(self) -> dict:
        ...
        masks = list(self._iter_test_masks(self.dataset.ndata["x"], self.dataset.ndata["y"]))
    ...
    def split(self) -> Dict[str, object]:
        ...
        elif self.data_config["split_type"] == "test":
            # Any number of sets of evenly distributed classes, but equal split sizes
